...
- Адрес: https://seller.wildberries.ru/instructions/ru/kg/material/api-integration-with-token-kg
- Идентификатор: A-1148
- Обновлено: 2026-05-28T16:52:59.597821Z

---
> **Примечание**
>
> Эта статья — для продавцов из Кыргызстана ![🇰🇬](https://static-basket-02.wbbasket.ru/vol20/article-static/acc0ab15-3309-4a02-a32c-58a218328455.webp)
...
> **Обратите внимание**
>
> Создавать и удалять токены может только владелец личного кабинета. При смене номера телефона владельца в личном кабинете все токены перестают корректно работать, их нужно будет создавать заново
...
> **Примечание**
>
> О том, как создать, удалять или обновлять токены, читайте [в отдельной статье](https://seller.wildberries.ru/instructions/ru/kg/material/how-to-create-update-or-delete-a-wb-api-token-kyrgyzstan)
