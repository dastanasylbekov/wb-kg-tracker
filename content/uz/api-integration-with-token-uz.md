...
- Адрес: https://seller.wildberries.ru/instructions/ru/uz/material/api-integration-with-token-uz
- Идентификатор: A-1155
- Обновлено: 2026-05-28T16:59:45.652491Z

---
> **Примечание**
>
> Эта статья — для продавцов из Узбекистана ![🇺🇿](https://static-basket-02.wbbasket.ru/vol20/article-static/8d91bf0c-3e5b-4cf3-b2f5-255774cd56e0.webp)
...
> **Примечание**
>
> О том, что такое API и для чего он нужен продавцам, читайте [в отдельной инструкции](https://seller.wildberries.ru/help-center/article/A-1154?categoryId=019711ab-731a-778a-a87e-3ef8983b817f)
...
> **Обратите внимание**
>
> Создавать и удалять токены может только владелец личного кабинета. При смене номера телефона владельца все токены перестают корректно работать, их нужно будет создавать заново
...
> **Примечание**
>
> О том, как создать, удалять или обновлять токены, читайте [в отдельной статье](https://seller.wildberries.ru/instructions/ru/uz/material/how-to-create-update-or-delete-a-wb-api-token-uzbekistan)
