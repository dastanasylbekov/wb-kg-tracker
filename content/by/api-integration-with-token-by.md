...
- Адрес: https://seller.wildberries.ru/instructions/ru/by/material/api-integration-with-token-by
- Идентификатор: A-1145
- Обновлено: 2026-05-28T16:46:54.003423Z

---
> **Примечание**
>
> Эта статья — для продавцов из Беларуси ![🇧🇾](https://static-basket-02.wbbasket.ru/vol20/article-static/40fa3a03-2b73-43ad-864b-09d8e5d2a45a.webp)
...
> **Примечание**
>
> О том, как создать, удалять или обновлять токены, читайте [в отдельной статье](https://seller.wildberries.ru/instructions/ru/by/material/how-to-create-update-or-delete-a-wb-api-token-belarus)
